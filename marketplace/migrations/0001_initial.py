    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', models.DecimalField(decimal_places=1, default=0.0, max_digits=30)),
            ],
        ),
        migrations.CreateModel(
            name='SellOrder',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('transactionID', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='marketplace.Transaction')),
                ('time', models.DateTimeField(auto_now_add=True)),
                ('transactionType', models.CharField(choices=[('CR', 'Credit'), ('DR', 'Debit')], max_length=2)),
                ('WalletUser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marketplace.Wallet')),
            ],
        ),
        migrations.AddField(
            model_name='wallet',
        ...
        migrations.CreateModel(
            name='GameReview',
            fields=[
                ('review', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='marketplace.Review')),
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marketplace.Game')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='gameDLC',
            fields=[
                ('gameID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='marketplace.Game')),
                ('timesBought', models.IntegerField(default=0)),
                ('DLCid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marketplace.DLC')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('review', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='marketplace.Review')),
                ('stars', models.DecimalField(decimal_places=1, max_digits=2, validators=[django.core.validators.MaxValueValidator(5), django.core.validators.MinValueValidator(0)])),
                ('compatibility', models.DecimalField(decimal_places=1, max_digits=2, null=True, validators=[django.core.validators.MaxValueValidator(5), django.core.validators.MinValueValidator(0)])),
                ('DLCname', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marketplace.DLC')),
            ],
            options={
